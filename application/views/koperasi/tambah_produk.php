    ...
    $('#btnsubmitProduk').click(function(){
        ...
        var tbkoperasi = "<?php $this->session->userdata('iduser') ?>";
        //var gambars = $("#tbimagelist").val();
        //pass object in post
        var form_data = new FormData();
        var ins = document.getElementById('tbimageProduct').files.length;
        for (var x = 0; x < ins; x++) {
            form_data.append("files[]", document.getElementById('tbimageProduct').files[x]);
        }
